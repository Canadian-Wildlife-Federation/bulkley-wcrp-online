...
![Figure 6: Situation analysis developed by the Planning Team to identify factors that contribute to fragmentation (orange boxes), biophysical results (brown boxes), and potential strategies/actions to improve connectivity (yellow hexagons) for focal species in the Bulkley River watershed.](images/Situation_Analysis.jpg) 
...
#| label: table-18
#| tbl-cap: "Table 18: Strategy 1 – Barrier Rehabilitation. "
#| warning: false
#| echo: false
...
data <- read.csv("data/bulk_strategy1_barrier_rehab.csv", check.names=FALSE)
ft <- flextable(data)
...
```{r echo = FALSE, results = 'asis'}
#| label: table-19
#| tbl-cap: "Table 19: Strategy 2 – Barrier Prevention"
#| warning: false
#| echo: false
...
data <- read.csv("data/bulk_strategy2_barrier_prevention.csv", check.names=FALSE)
ft <- flextable(data)
ft <- format_flextable(ft)
ft
```
...
```{r echo = FALSE, results = 'asis'}
#| label: table-20
#| tbl-cap: "Table 20: Strategy 3 – Strengthen Indigenous connections to land and water"
#| warning: false
#| echo: false
...
data <- read.csv("data/bulk_strategy3_indigenous_connections.csv", check.names=FALSE)
ft <- flextable(data)
ft <- format_flextable(ft)
ft
```
...
![Figure 7: Theory of change developed by the Planning Team for the actions identified under Strategy 1: Barrier Rehabilitation in the Bulkley River watershed.](images/Fig_7_theory.png)

![Figure 8: Theory of change developed by the Planning Team for the actions identified under Strategy 2: Barrier Prevention in the Bulkley River watershed.](images/Fig_8_theory.png)
