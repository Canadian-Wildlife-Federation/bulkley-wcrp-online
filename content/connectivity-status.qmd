...
def watershed_connectivity(habitat_type):
    ...
    return str(round(connect_stat,2))
...
df = pd.DataFrame({"Target Species":["Andromous Salmon"," "],
                   ...
                   "Poor":["<50%"," "],
                   "Fair":["51-75%"," "],
                   "Good":["76-90%", watershed_connectivity("SPAWNING")],
...
def highlighttab7(val):
    ...
    elif val[0:].isdigit() and (int(val) >= 51 and int(val) < 76) : color = lgreen 
    elif val=="76-90%"  : color = lgreen
    elif is_float(val) and (float(val) >= 76 and float(val) < 90) : color = lgreen 
...
df = pd.DataFrame({"Target Species":["Andromous Salmon",""],
                   ...
                   "Poor":["<50%"," "],
                   "Fair":["51-75%",watershed_connectivity("REARING")],
                   "Good":["76–90%"," "],
                   "Very Good":[">90%"," "]
                   })
...
def highlighttab7b(val):
    ...
    elif is_float(val) and (float(val) >= 51 and float(val) < 75) : color = yellow 
    elif val=="76–90%"  : color = lgreen
...
df = pd.DataFrame({"Goal #": [1,2],
                   "Goal": ["By 2031, the percent (%) of total linear spawning habitat accessible to anadromous salmonids will increase from 87.9% to 95% within the Bulkley River watershed (i.e., reconnect at least 89.59 km of spawning habitat).",
                            "By 2031, the percent (%) of total linear rearing habitat accessible to anadromous salmonids will increase from 71.96% to 80% within the Bulkley River watershed (i.e., reconnect at least 168.29 km of rearing habitat). "]
                    })
