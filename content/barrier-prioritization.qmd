...
df = pd.DataFrame({"Habitat Type":["Spawning","Rearing"],
                   "Currently accessible (km)":[str(watershed_connectivity("SPAWNING")[2]),str(watershed_connectivity("REARING")[2])],
                   "Total": [str(watershed_connectivity("SPAWNING")[1]),str(watershed_connectivity("REARING")[1])],
                   "Current Connectivity Status":[str(watershed_connectivity("SPAWNING")[0])+"%",str(watershed_connectivity("REARING")[0])+"%"],
                   "Goal": ["95%","80%"],
                   "Gain required (km)": [round((watershed_connectivity("SPAWNING")[1]*0.96)-watershed_connectivity("SPAWNING")[2],2),round((watershed_connectivity("REARING")[1]*0.96)-watershed_connectivity("REARING")[2],2)]
                   })
