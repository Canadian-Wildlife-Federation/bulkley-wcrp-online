...
#| label: tbl-param-bulkley
#| tbl-cap: "Parameters and thresholds used to inform the Intrinsic Potential habitat model for spawning and rearing habitat for each focal species in the Bulkley River watershed."
#| warning: false
...
#data = pd.read_csv('data/params-bulkley.csv', index_col=False)
